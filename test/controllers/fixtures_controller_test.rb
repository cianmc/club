...
class FixturesControllerTest < ActionController::TestCase
  ...
  test "should create fixture" do
    assert_difference('Fixture.count') do
      post :create, fixture: { date: @fixture.date, opposition: @fixture.opposition, referee: @fixture.referee, time: @fixture.time, venue_id: @fixture.venue_id }
    end
  ...
  test "should update fixture" do
    patch :update, id: @fixture, fixture: { date: @fixture.date, opposition: @fixture.opposition, referee: @fixture.referee, time: @fixture.time, venue_id: @fixture.venue_id }
    assert_redirected_to fixture_path(assigns(:fixture))
  end
